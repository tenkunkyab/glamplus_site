...
function About() {
  ...
  const redirectUserToLinkedIn = () => {
    window.open("https://www.linkedin.com/company/glamplus/jobs/", "_blank").focus();
  };
  ...
  return (
    <div className="w-full overflow-hidden relative">
      ...
      {width > 1000 ? (
        ...
        <>
          <div className="w-full h-[30%] lg:h-[40%] xl:h-[35%] absolute z-0">
            <Image src="/images/careersBG1.svg" layout="fill" objectFit="cover" />
          </div>
          <div className="w-full h-[70%] bottom-[-6%] lg:h-[80%] xl:h-[90%] xl:bottom-[-10%] absolute z-0">
            <Image src="/images/aboutBG2.svg" layout="fill" objectFit="cover" />
          </div>
        </>
      ) : (
        ...
        <>
          <div className="w-full h-[40%] sm:h-[50%] md:h-[60%] absolute z-0">
            <Image src="/images/careersMobileBG1.svg" layout="fill" objectFit="cover" objectPosition="top left" />
          </div>
      ...
      <div className="relative max-w-[1800px] m-auto flex flex-col items-center gap-[80px] md:gap-[120px] xl:gap-[150px] pt-[30px] pb-[40px] md:py-[50px] lg:py-[100px] xl:py-[140px]">
        ...
        <Team className="px-[20px]" cta={redirectUserToLinkedIn} />
        <Culture className="px-[40px] md:px-[20px]" />
        <button
          className="button w-[90%] md:w-[586px] max-w-[586px] text-[12px] sm:text-[15px] md:text-[20px] lg:text-[25px] xl:text-[32px] lg:p-[20px]"
          onClick={redirectUserToLinkedIn}
        >
          Join Our Team
        </button>
        ...
        <Impact />
        <form
          action="mailto:cx@glamplus.in"
          className="px-[30px] w-full sm:w-[80%] md:w-[70%]  grid grid-cols-2  gap-[50px] xl:gap-[100px] justify-items-center"
        >
          <input type="hidden" name="subject" value="Schedule a Demo" />
          <button
            type="button"
            className="button w-full max-w-[453px] text-[12px] sm:text-[15px] md:text-[20px] lg:text-[25px] xl:text-[32px] lg:p-[20px]"
            onClick={redirectUserToLinkedIn}
          >
            Join Our Team
          </button>
