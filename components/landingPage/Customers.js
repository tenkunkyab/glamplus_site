...
function Customers() {
  ...
  return (
    <div className="min-h-[600px] h-full py-10 max-w-[1800px] m-auto xl:min-h-[800px]">
      ...
      <div
        className={`customer-review-slides min-w-fit p-2 m-auto min-h-[450px] lg:min-h-[550px] xl:min-h-[800px]`}
        onClick={() => setPauseAnimation(!pauseAnimation)}
      >
        <div
          className={`mover-1 lg:relative ${pauseAnimation ? "pause-animation" : "start-animation"} xl:animation-none py-2`}
        >
