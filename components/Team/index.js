...
function MemberView({ className, imgSrc, name, role }) {
  return (
    <div
      className={`w-[100%] flex flex-col items-center p-[10px] rounded-lg gap-[20px] ${className}`}
    >
      <div
      ...
      <div className="flex flex-col items-center text-center w-[100%]">
        <h1 className={`font-[500] text-[#263741] text-[18px] md:text-[24px] lg:text-[28px] xl:text-[32px] `}>{"Siddharth Guha"}</h1>
        <h3 className={`font-[500] text-[#8B8B8B] text-[14px] md:text-[16px] lg:text-[18px] xl:text-[24px] `}>{"Operations Manager"}</h3>
        <p  className={`font-[400] text-[#8B8B8B] text-[14px] md:text-[16px] lg:text-[18px] xl:text-[24px]  mt-[10px]`}>{"Former Cofounder of Opendoor. Early staff at Spotify and Clearbit"}</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className={`flex flex-col gap-[20px] lg:gap-[50px] ${className}`}>
      ...
      <div className="m-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[30px] md:gap-[50px] lg:gap-[100px] 2xl:gap-x-[150px] xl:gap-y-[122px] justify-items-center mx-auto">
        ...
        {/* Join our Team */}
        <div
            className={`w-[100%] flex flex-col items-center p-[10px] rounded-lg gap-[20px]`}
          >
            <div
              className={`w-[150px] h-[150px] md:w-[180px] md:h-[180px] xl:w-[200px] xl:h-[200px] circularImg boxShadowSkyBlue cursor-pointer`}
            >
              <Image
                className="rounded-full"
                src={"/icons/plus.svg"}
